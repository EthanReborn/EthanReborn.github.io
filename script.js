...
//special ability
var combined = adjectives.concat(nouns);
shuffleArray(combined);
wordLists.push(combined);
...
adj6.onclick = function () { toggleSelected1(); }
...
noun5.onclick = function () { toggleSelected2(); }
...
function completedStep(div, list1, list2) {
    ...
    if (nextIndex == nextDivs.length - 3){
        container.setAttribute('class', 'clear-3-columns');
