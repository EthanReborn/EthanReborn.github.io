...
var adj7 = document.createElement('p');
adj7.textContent = "";
...
var adj6 = document.createElement('p');
adj6.textContent = "";
...
var noun5 = document.createElement('p');
noun5.textContent = "";
...
function completedStep(div, list1, list2) {
    ...
    if(nextIndex >= nextDivs.length || wIndex >= wordLists.length){
        ...
        buttonDiv.setAttribute('class', 'clear-1-column');
        ...
        buttonDiv2.setAttribute('class', 'clear-1-column');
    ...
    if (nextIndex == 12){
        ...
        setTimeout ( () => {
            ...
            text.setAttribute('class', 'non-hover-text');
    ...
    if (nextIndex == nextDivs.length - 3) {
        ...
        space.setAttribute('class', 'non-hover-text');
