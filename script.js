...
var verbs = [
    ...
    ["help", 400],
    ["vote for", -1000],
    ["become president of", -1500],
    ["become leader of", -1200],
    ["become king of", 1400],
    ["be a slave to", -2000],
    ["lead", 1800],
    ["die in", -2000],
...
var locationsAndPlurals = [
    ...
    ["a time machine", 2000],
    ["a grape", -500],
    ["the Atlantic Ocean", 1600],
    ["the Pacific Ocean", 1600],
    ["India", 900],
    ["Japan", 1100],
    ["The British", 700],
    ["Middle-Earth", 2000],
...
function animateScoreUpdate(element, startValue, targetValue, duration) {
    ...
    function updateScore() {
      ...
      // Update the display
        ...
        element.innerHTML = `
            <span style="color: ${points > 0 ? 'green' : 'red'}; text-shadow: -2px -2px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000;">
            ${points > 0 ? '+' : ''}${points}
            </span><br>
